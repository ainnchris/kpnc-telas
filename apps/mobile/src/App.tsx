...
function errorMessage(error:unknown){
  ...
  if(/^(Informe|Código|Esta reunião|O anfitrião|O compartilhamento|O chat|A atualização|Não foi possível)/i.test(value))return value;
